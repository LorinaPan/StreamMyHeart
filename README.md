...
- macOS:
  - `cmake --preset macos -DENABLE_DEBUG_FEATURES=ON`
  - `cmake --build --preset macos`
- Windows:
  - `cmake --preset windows-x64 -DENABLE_DEBUG_FEATURES=ON`
  - `cmake --build --preset windows-x64`
- Ubuntu:
  - `cmake --preset ubuntu-x86_64 -DENABLE_DEBUG_FEATURES=ON`
...
- Advanced Algorithm
    ...
    - Experimental async mode schedules Dlib analysis at 15 Hz and renders cached results every frame.
