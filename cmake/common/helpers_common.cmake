...
set(_plugin_support_template "")
set(_plugin_support_header "")
set(_plugin_support_include_dir "")

if(EXISTS "${CMAKE_CURRENT_SOURCE_DIR}/src/plugin-support.c.in")
  set(_plugin_support_template "src/plugin-support.c.in")
  set(_plugin_support_header "src/plugin-support.h")
  set(_plugin_support_include_dir "${CMAKE_CURRENT_SOURCE_DIR}/src")
elseif(EXISTS "${CMAKE_CURRENT_SOURCE_DIR}/src/obs/plugin/plugin-support.c.in")
  set(_plugin_support_template "src/obs/plugin/plugin-support.c.in")
  set(_plugin_support_header "src/obs/plugin/plugin-support.h")
  set(_plugin_support_include_dir "${CMAKE_CURRENT_SOURCE_DIR}/src/obs/plugin")
endif()

if(_plugin_support_template)
  configure_file(${_plugin_support_template} plugin-support.c @ONLY)
  add_library(plugin-support STATIC)
  target_sources(plugin-support PRIVATE plugin-support.c PUBLIC ${_plugin_support_header})
  target_include_directories(plugin-support PUBLIC "${_plugin_support_include_dir}")
